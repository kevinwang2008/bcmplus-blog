---
title: "把演练做成能力建设工程：《The ENISA Cybersecurity Exercise Methodology》导读"
date: 2026-03-09
original_url: https://mp.weixin.qq.com/s/DIXOZ-meBgU68ZQECiN1UQ
source: "公众号：业务连续性+"
author: "王曙"
---

如果你负责网络安全、数字韧性、业务连续性、危机管理，或者你本身就是CISO、风险负责人、管理层成员——那么欧盟网络安全局（ENISA）于2026年发布的《TheENISA Cybersecurity Exercise Methodology》，值得你认真研读。
...
lstructured planning（结构化规划）

lcapacity building（能力建设）

lflexibility（灵活性）

lresource ecosystem（资源生态）

lcommunity collaboration（社区协作）
...
l第一条：从目标到能力。ENISA在附录C中专门设置了“From objectives to capabilities”,说明演练目标不是抽象口号，而应落到具体能力。

l第二条：从角色到责任。文件引入European Cybersecurity Skills Framework (ECSF)，把演练中的相关角色与职责映射到更规范的能力与岗位语境中。
...
没有“why”的牵引的演练，只是流程合规；而有使命驱动的演练，才能催生能力跃迁。
...
lDiscussion-based（基于讨论）：seminar/workshop、tabletop

lOperation-based（基于行动）：drill、game、operational exercise。
...
* 对一个1天的国家级演练，计划演练时间6小时(= 6/8 = 0.75），复杂度中高（= 4），3个主要相关方（= 3），经验有限的策划团队（= 2）；则所需准备时间为：
...
宁可把少数关键领域测深，也不要在一个过于宠杂的范围里浅尝辄止。
...
lIncident：其中发生的具体安全事件

lInject：特定时点送达给参与者的信息或动作。
...
l文件区分了communication check和dry run：前者是测试玩家是否能按预定方式收到注入信息，后者是策划团队用来验证MSEL内容与节奏的内部演练。

l文件对facilitator和observer的角色都讲得很清楚：facilitator要推动流程但不能把参与者导向预设结论，observer要保持中立，不因看见错误就介入纠正。
...
第一，演练应当被放回治理与能力建设框架中理解，而是作为独立活动处理。文件从目标、能力、角色、交付物到改进闭环的设计，正是把演练纳入治理逻辑。
...
它指醒我们，演练不只是模拟攻击，不只是测试流程，也不只是一次教育活动。它更应该是一种有目标、有范围、有控制、有评估、能转化为后续行动的能力建设机制。

演练不是为了“完成一次活动”，而是为了让组织在真实危机到来之前，提前暴露问题、校准能力，并能过持续改进让组织变得更可靠。
...
![](images/DIXOZ-meBgU68ZQECiN1UQ_01.jpg)
![](images/DIXOZ-meBgU68ZQECiN1UQ_02.jpg)
![](images/DIXOZ-meBgU68ZQECiN1UQ_03.jpg)
![](images/DIXOZ-meBgU68ZQECiN1UQ_04.jpg)
![](images/DIXOZ-meBgU68ZQECiN1UQ_05.jpg)
![](images/DIXOZ-meBgU68ZQECiN1UQ_15.jpg)
![](images/DIXOZ-meBgU68ZQECiN1UQ_16.jpg)
![](images/DIXOZ-meBgU68ZQECiN1UQ_17.jpg)
...
---
*原文发表于公众号"业务连续性+" | [原文链接](https://mp.weixin.qq.com/s/DIXOZ-meBgU68ZQECiN1UQ)*
