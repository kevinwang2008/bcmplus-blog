...
指导方针，包括同时在线公布的支持性的目标能力清单，取代了临时国家准备目标，并定义了国家准备好庆对危险的意义。指导方针有四个关键要素：
...
2.1指导方针是一系列就绪举措的综合体 The Guidelines Are the Umbrella for a Range of Readiness Initiatives
...
2.2 指导方针是适用于全危险的The Guidelines Are All-Hazards
...
2.3 指导方针是基于风险的The Guidelines Are Risk-Based
...
2.4 指导方针是行动的号召The Guidelines Are a Call to Action
...
政府官员在与私营部门、非政府组织和公民个人合作时面临的挑战是，确定建设能力以加强准备和实现指导方针的最佳方式。全国各地的“最佳方式”各不相同。为了协助官员开展这项工作，指导方针建立了一个基于能力的准备过程和三个规划工具：国家规划情景；目标能力清单（TCL）；以及附录B中详细讨论的通用任务清单（UTL）。国家规划情景旨在确定全危险准备所需的广泛的任务和能力。TCL是执行国土安全使命的综合能力目录，包括常见任务的绩效度量和指标。UTL是按国土安全使命领域划分的任务库和层次结构。基于能力的准备鼓励灵活性并需要协作。更重要的是，它有助于确保全国各地的行动规划人员和项目经理在制定规划、培训、设备和其他投资时能够使用通用的工具和过程，并能够产生可衡量的结果。有关指导方针如何促进具体国土安全能力发展的更多信息，请参阅附录B。
...
HSPD-8指示，指导方针确立可测量的就绪度优先事项和目标。指导方针包括一系列国家优先事项，以指导准备工作满足国家最紧迫的需求（见图5）。优先事项反映了国家战略、总统令、州和城市地区国土安全战略、卡特里娜飓风报告和其它经验教训报告中确定的主要主题和反复出现的问题。随着指导方针的实施或国土安全战略环境的变化，优先事项将随时间推移而更新或完善。
...
国家优先事项：区域合作的标准化结构和过程使各实体能够一致和有效地共同管理和协调行动和准备活动。
...
讨论：区域合作对于改进准备和实现指导方针中规定的原则至关重要。在本文件中，“地区”通常指由相邻的联邦、州、地方、部落和领地管辖区组成的地理区域。重大事件往往具有区域性影响；因此，预防、保护、响应和恢复任务需要广泛的区域合作。加强联邦、州、地方、部落和领地实体与私营部门、非政府组织和公民个人之间的沟通和协调至关重要。其目的是确定最有利于实现和维持协调一致的能力和互助协议的地理区域。联邦部门和机构应通过规划和联邦准备援助来促进这些区域性组群。地理区域之间的正式协议将使联邦政府能够与各州、领地、地方和部落政府以及其他合作伙伴合作，更有效地协调准备活动，分摊成本，集中资源，分担风险，从而提高总体投资回报。
...
有关国土安全拨款倡议（如UASI）的更多信息，请在线访问：http://www.ojp.usdoj.gov/odp/grants_programs.htm。

有关城市就绪倡议的更多信息，请在线访问：http://www.bt.cdc.gov/cri/。

有关EMAC的更多信息，请在线访问：http://www.emacweb.org。
...
国家重点事项：在全国范围内全面实施国家事件管理系统（NIMS）和国家响应计划（NRP），支持能力协调一致的发展。
...
讨论：2003年2月28日的国土安全总统令第5号（HSPD-5）（“国内事件管理”）授权开发NIMS和NRP。2004年3月发布的NIMS为各级政府实体合作管理国内事件提供了一个一致的框架，无论原因、规模或复杂性如何。NIMS包括一套核心指导方针、标准和协议，用于指挥和管理、准备、资源管理、通信和信息管理、支持技术以及协调和维护，以促进联邦、州、地方、部落和领地能力之间的互操作性和兼容性。
...
有关NIMS的更多信息，请在线访问：http://www.fema.gov/emergency/nims/。

有关NRP的更多信息，请在线访问：http://www.dhs.gov/dhspublic/interapp/editorial/editorial_0566.xml。
...
国家重点事项：在全国范围内全面实施国家基础设施保护计划，支持关键基础设施保护能力的协调发展。
...
欲了解更多信息，可在线访问：www.dhs.gov/nipp。

评论和提问可以发送给：NIPP@dhs.gov。

For more information, the NIPP is available online at: www.dhs.gov/nipp 
...
国家优先事项：发展信息共享和协作能力，达到州、部落地区、领地和指定城市地区的目标水平，并与TCL中既定的度量和指标保持一致。
...
讨论：这一国家优先事项重点关注TCL中概述的情报和信息共享与传播以及反恐调查和执法能力。它还与加强可互操作和可操作通信能力的国家优先事项密切相关（见第4.5节）。只有通过运行的互操作通信网络支持的国家信息管理系统，才能实现通用作战图。
...
有关国土安全信息网络的更多信息，请在线访问：http://www.dhs.gov/xinfoshare/programs/gc_1156888108137.shtm。

有关联邦调查局和司法部在这一领域工作的更多信息，请在线访问：http://www.fbi.gov/terrorinfo/counterrorism/waronterrorhome.htm。

有关ISE的更多信息，请在线访问：http://www.ise.gov。
...
国家优先事项：发展可互操作和可操作的通信能力，达到各州、部落地区、领地和指定城市地区的目标水平，并与TCL中既定的度量和指标相一致。
...
讨论：这一国家优先事项重点关注TCL中的通信能力。通信互操作性是指公共安全机构（包括警察、消防、EMS等）和服务机构（包括公共工程、交通、医院等）通过无线电和相关通信系统在机构和管辖区内和跨机构和管辖区进行对话的能力；按需相互交换语音、数据和/或视频；并在需要时和获得授权时实时执行。
...
有关SAFECOM的更多信息，请在线访问：http://www.safecomprogram.gov/SAFECOM。

有关IWN的更多信息，请在线访问：http://www.usdoj.gov/jmd/iwn/。

有关TICP的更多信息，请在线访问：http://www.ojp.usdoj.gov/odp/ta_ictap.htm。

有关全国互操作通信基线调查的更多信息，请在线访问：http://www.safecomprogram.gov/SAFECOM/library/background/1295_2006national.htm。
...
Additional information on the Nationwide Interoperable Communications Baseline Survey can be found online at: http://www.safecomprogram.gov/SAFECOM/library/background/1295_2006national.ht 

4.6加强CBRNE检测、响应和净化能力 Strengthen CBRNE Detection, Response, and Decontamination Capabilities

国家优先事项：发展化学、生物、辐射性、核和爆炸物（CBRNE）的检测、响应和净化能力，达到各州、部落地区、领地和指定城市地区的目标水平，并与TCL中既定的度量和指标相一致。
...
有关NRP与CBRNE相关的其他信息，请在线访问：http://www.dhs.gov/nationalresponseplan。
...
国家优先事项：发展医疗激增和大规模预防能力，达到各州、部落地区、领地和指定城市地区的目标水平，并与TCL中既定的测度量和指标相一致。
...
有关HHS准备优先事项的其他信息，请在线访问：http://www.hhs.gov/ophep/npgs.html。

有关医疗激增的更多信息，请在线访问：http://www.hrsa.gov/bioterrorism/。

有关大规模预防的更多信息，请访问美国疾病控制与预防中心恐怖主义准备和应急响应协调办公室网站：http://www.bt.cdc.gov。
...
国家优先事项：发展规划和公民准备能力，达到各州、部落地区、领地和指定城市地区的目标水平，并与TCL中既定的度量和指标保持一致。
...
由于穿制服的应急人员不到美国总人口的百分之一，很明显，公民必须更好地准备，接受培训，并练习如何在灾难性事件发生期间和之后的最初、关键时刻最好地照顾自己和帮助他人。公民可以通过准备措施减少灾难性事件期间对紧急援助的需求，并通过参与响应和恢复活动积极提高国家的响应能力。训练有素、积极参与的公众将为国家提供关键的快速增援能力，加强政府在灾难性事件中的努力。卡特里娜飓风期间，许多公民采取了适当的预防和响应行动，许多公民自愿支持响应和恢复工作。2006年2月，白宫发布了《联邦政府对卡特里娜飓风的响应：经验教训》，其中强调“公民和社区准备是预防恐怖袭击以及保护、减轻、响应和从所有危险中恢复的最有效手段之一……如果每个家庭都制定了自己的应急准备计划，他们几乎肯定会减少对外部应急资源的需求。”通过“就绪运动”以及州和地方公民团委员会的全国网络，DHS将重点加强公民的准备能力，特别是针对特殊需求和社会弱势群体的准备能力。
...
有关FEMA和规划的更多信息，请在线访问：http://www.fema.gov/plan/。

有关规划标准的更多信息，请在线访问：www.nfpa.org/PDF/nfpa1600.pdf？src=nfpa。

有关社区准备和参与的更多信息，请在线访问：http://www.citizencorps.gov/。

有关就绪运动的更多信息，请在线访问：http://www.ready.gov/。

Additional information on FEMA and Planning can be found online at: http://www.fema.gov/plan/ 

Additional information on planning standards can be found online at: www.nfpa.org/PDF/nfpa1600.pdf?src=nfpa 
...
国家准备系统提供了一种根据国家准备指导方针组织准备活动和项目的方法（见图6）。我们的《国家准备系统》的理想最终状态是实现并保持协调一致的能力，以平衡风险和资源的方式预防、保护、响应所有危险并从中恢复。
...
国家准备系统为各级政府、私营部门、非政府组织和公民个人提供了合作的机会，以实现指导方针中概述的优先事项和能力。许多活动会同时进行。下面按顺序描述它们：

政策和学说包括持续管理和维护行动和准备的国家政策和学说，如NIMS、NRP、NIPP和指导方针。

规划和资源分配包括政府官员应用共同的规划过程和工具，与私营部门、非政府组织和公民个人合作，确定需求、分配资源，并建立和保持基于风险排定优先级的、协调一致的能力。

培训、演练和经验教训包括提供培训和演练以及绩效评估，以确定经验教训并分享有效的实践。

评估和报告包括根据既定的就绪度指标进行评估，并报告为实现指导方针的愿景而开展的工作的进展情况和有效性。
...
由于指导方针将通过广泛的准备项目和活动逐步实施，因此不包括具体的实施说明（关于将指导方针制度化的指导意见见附录A的指令函）。在法律允许的范围内，接受联邦准备援助的要求、年度联邦项目指南和联邦法规的变化也将支持指导方针的实施。许多项目和活动已经与指导方针保持一致，只需要在更密切的协调下实施。其他合作伙伴可能需要启动或调整项目和举措（以及可衡量的目标），以实施指导方针。实施情况和合作伙伴反馈将为今后改进指导方针提供信息。DHS将协调建立国家级的结构和过程，以持续管理和维护指导方针。这将与NIMS、NRP、NIPP和国家准备系统其他要素的类似结构和过程密切协调，以帮助确保国家政策与行动和准备规划相互支持。
...
DHS致力于与国土安全合作伙伴合作，更新和维护指导方针和相关文件，作为统一的国家准备系统的一部分，这将有助于确保各级政府协调一致的战略、计划、程序、政策、培训和能力。国家准备系统的实施顺利进行。它的基础是风险评估、管理政策和战略的制定、综合计划中特定任务和支持任务的确定，以及执行这些政策、战略和计划的能力与需求的匹配。联邦、州、地方、部落和领地政府将定期参与就绪度评估。国家准备系统将强调反馈和定期重新评估，以确保当前的准备状态以就绪度指标为基础，并用作政策和项目决策的基础。HSPD-8要求国土安全部长向总统提供关于国家准备水平的年度状态报告，包括州能力、联邦民事响应资产的就绪情况、互助的利用情况，以及对联邦准备项目如何支持指导方针的评估。这些报告将有助于指导方针的更新。
...
2. Planning Tools Referenced in the Guidelines
...
The 37 capabilities referenced in the Guidelines span the full spectrum of homeland security missions. While the listing does not yet encompass every function that must be accomplished to prevent, protect against, respond to, or recover from a major event, it nonetheless offers a comprehensive starting point for planning. Each capability is described in detail in the Target Capabilities List (TCL), which accompanies the Guidelines. The description includes a definition, outcome, preparedness and performance activities, tasks, and measures.
 ...
 指导方针中引用的规划工具Planning Tools Referenced in the Guidelines
...
各级政府的规划人员可以使用TCL作为参考，帮助他们设计计划、程序、培训和演练，以提高在重大事件中执行指定使命和任务的容量和熟练程度。TCL是与联邦、州和地方主题专家共同开发的，并尽可能利用现有资源。它将与UTL一起定期更新。当前版本可在ODP安全门户(https://odp.esportals.com )和经验教训信息共享系统(https://www.llis.dhs.gov)上获得。
...
UTL是与联邦、州、地方、部落、领地、私营部门和非政府主题专家共同开发的，并尽可能利用现有资源。UTL将与TCL一起定期更新。当前版本可在ODP安全门户(https://odp.esportals.com)和经验教训信息共享系统(https://www.llis.dhs.gov)上获得。
...
识别选项所识别的选项范围应保持在可管理的数量上，但是解决方案应根据实现能力所需的要素来构建。能力可以借由合理规划、组织、装备、培训和演练人员实现预期结果的任何组合而得到。在审查选项时，应考虑在地理区域和各级政府之间实施互助的有效性。
...
分析选项一旦识别了一系列选项，就应根据一套标准的准则对每个选项进行分析并确定其优先级。分析将确定能够提供所需能力的资源组合，并将适当地处理风险。准则的示例包括：
...
选择选项分析结果将提交给高级决策者考虑。风险确定是决策过程的一部分。风险确定将考虑能力差距、过剩和不足的范围；在分析期间发现的问题（如分析选项组成部分的准则中发现的）；以及战略关切和影响。风险确定还将考虑以下因素：
...
有关培训和演练的基于能力的准备规划的更多信息，请参阅国土安全演练和评价项目第一卷：

概述和演练项目管理(http://hseep.dhs.gov).
...
For more on Capabilities-Based Preparedness Planning for training and exercises, see Homeland Security Exercise and Evaluation Program Volume I:

Overview and Exercise Program Management (http://hseep.dhs.gov).
...
全危险准备指为美国境内的恐怖袭击、重大灾难和其他紧急情况做准备。（资料来源：HSPD-8，2003年12月17日）
...
能力能力提供了在特定条件下由执行一项或多项关键任务而完成使命和功能达到目标绩效水平的手段。能力可以借由合理规划、组织、装备、培训和演练的人员实现预期结果的任何组合而得到。
...
关键基础设施关键基础设施被定义为对美国至关重要的系统和资产（无论是物理的还是虚拟的），以至于这些系统和资产的失效或破坏将对国家安全、国家经济安全或国家公共卫生或安全的任何组合产生削弱性影响。（资料来源：2001年《美国爱国者法》和2002年《国土安全法》，《美国法典》第6卷第101节等）
...
关键任务关键任务是指那些对于在预防重大事件发生、最大限度地减少生命损失和严重伤害，或减轻重大财产损失的国土安全使命中取得成功至关重要的任务。
