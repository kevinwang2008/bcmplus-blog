---
title: "《ISO 22361 - 危机管理指南》中文简译（上）"
date: 2024-04-22
original_url: https://mp.weixin.qq.com/s/mpJutSNntAae51WNGJvyXw
source: "公众号：业务连续性+"
author: "王曙"
---

写在前面
：业务连续性、应急和危机管理虽各有侧重但又密切关联，相关专业人员在精通本领域知识、方法和技能的同时，必须了解（进而掌握）其它领域的知识和方法，方能在实践中有效协同，成功处置突发/扰断/危机事件。ISO 22301系列标准是业务连续性管理领域全球最佳实践的集大成者，之前我和一些专家志愿者团队翻译过相关资料（见下面译文及链接），这次，我带来了《ISO 22361:2022 – 危机管理指南》的中文简译，供专业人员参考，也请各位专家多提修改意见。
《ISO 22301:2019中文简译》
（2020年11月）
...
![](images/mpJutSNntAae51WNGJvyXw_01.jpg)
...
![](images/mpJutSNntAae51WNGJvyXw_02.jpg)

Figure 1 — Bu
ilding a crisis management capability — Principles, framework and process
...
为实现
目标
（3.20）而具有自身职能及职责、权限和相互关系的一个人或一组人。。
...
可预测性
Predictability
事件通常是可预测的，尽管其具体时间、类型和影响各不相同。Incidents are generally foreseeable, although their specific timing, type and impact are variable.
危机一般是独特、罕见的事态和情况。有些危机可以被预见；然而，时机和影响通常并不总是可以预测。Crises are typically unique, rare events or situations. Some crises can be anticipated; however, timing and impact usually are not always foreseeable.
发生/肇始
Onset
事件可以是无通知或临时通知的破坏性事态，也可以是因渐进故障或失去控制而出现。Incidents can be no-notice or short-notice disruptive events, or they can emerge through a gradual failure or loss of control.
危机也可能发生在无通知或临时通知事态中。它们也可能来自未被遏制、管理不善或进一步升级而产生声誉后果的事件，并且需要危机级别的响应。Crises can also occur from a no-notice or short-notice event. They can also emerge from an incident that has not been contained, has been managed badly or further escalates to have reputational consequences, and which requires a crisis-level response.
紧迫感和压力
Urgency and pressure
在管理事件时，通常会有高度的紧迫感来采取行动，要么防止情况恶化，要么尽量降低其影响。In managing an incident, there is usually a high sense of urgency to act to either prevent the situation from getting worse or to minimize its impact.
危机总是需要紧急关注，因为影响可能非常大。考虑到潜在的影响以及危机更具可见性的事实，它通常会给组织带来很大的压力。A crisis always needs urgent attention as the impact can be very high. Given the potential impact and the fact that a crisis has more visibility it is common that it places a high level of pressure on the organization.
影响
Impacts
事件是指尽管需要大量资源来响应、但很少威胁到组织的生存或对其声誉产生重大长期影响的事态。这些影响通常是局部的，或者只影响组织的一部分。Incidents are events which, although they can take considerable resources to manage, rarely threaten the existence of the organization or have a major long-term impact on its reputation. The impacts are usually local or affect only a part of the organization.
事件通常是可控的，尽管对相关方的影响可能很严重，但它是可控的和暂时的。Incidents are generally manageable, and although the impact on interested parties can be severe, it is manageable and temporary.
危机可以破坏或影响整个组织，超越组织、地理或部门的界限。由于危机往往复杂且具有固有的不确定性，其长期影响可能难以评估。处理不当的危机会导致功能、价值观、信任和声誉灾难性的损失。这些负面影响可能会对组织产生持久的不利影响。危机可以导致这样一个结论，即在危机期间应该调整法律状况。Crises can disrupt or affect the entire organization, transcending organizational, geographical and sectoral boundaries. As crises tend to be complex and inherently uncertain, the long-term impacts can be difficult to assess. A badly handled crisis can lead to a catastrophic loss of functionality, values, trust and reputation. These negative impacts can have a lasting detrimental effect on the organization. Crisis can lead to the conclusion that the legal situation should be adjusted during the crisis.
组织的规模、地理位置和类型可能会使其更容易受到某些事件的影响，这些事件可能会成为危机。The size, location and type of an organization can make it more susceptible to certain incidents which can become a crisis.
公众、媒体和其它相关方的监督
Scrutiny by public, media and other interested parties
有效的事件管理，即快速识别不良事态，迅速减轻影响并快速恢复正常业务，可能很少或根本不会引起媒体的负面关注。Effective incident management, where-by adverse events are quickly identified, impacts rapidly mitigated and business-as-usual quickly restored, will probably attract little or no negative media attention.
如果存在负面报道，则可能仅限于一个地方或特定群体。然而，负面报道总是有可能扩大并蔓延到其他群体，导致事件成为危机。Where there is adverse publicity, this can be confined to a locality or a specific group. However, there is always the possibility of the adverse publicity growing and spreading to additional groups, leading to the event becoming a crisis.
危机可能引起公众、产品和服务用户、特定群体（如监管机构、股东或行业机构）和媒体（包括社交媒体）等相关方的重大审查和兴趣。Crises are likely to result in significant scrutiny and interest among interested parties including members of the public, product and service users, specific groups (such as regulators, shareholders or industry bodies) and the media, including social media.
对危机感兴趣的具体各方取决于事态的类型、它威胁到谁，以及它影响到谁。组织的所有行动和响应都很可能受到审查，任何被认为糟糕的决策、试图逃避责任、指责他人、对受害者的恶劣待遇或试图削减响应成本都可能导致进一步的持续批评和危机的深化，或可能带来新的挑战。The specific parties taking an interest in the crisis will depend on the type of event, who it threatens, and who it impacts. It is very likely that all actions and responses by the organization will be scrutinized and any perceived poor decisions, attempts to avoid responsibility, blaming of others, poor treatment of victims or attempts to cut costs on the response can lead to further sustained criticism and a deepening of the crisis, or can create new challenges.
通过建立计划和程序的可管理性
Manageability through established plans and procedures
事件通常可以通过使用包含事件管理程序和结构以及预定解决方案和可用资源的详细信息的计划来解决。最高管理者可能被告知或需要提供指导和监督。Incidents can often be resolved by using plans which contain incident management procedures and structures and details of predetermined solutions and available resources. Top management can potentially be informed or need to provide direction and supervision
危机由于其新颖性、固有的不确定性以及潜在的影响规模和持续时间的结合，很少能仅通过应用预先确定的程序和计划来解决。Crises, through a combination of their novelty, inherent uncertainty and potential scale and duration of impact, are rarely resolvable through the application of predefined procedures and plans alone.
它们要求领导层做出灵活、创造性、战略性和持续的回应。价值观和行为可能被挑战并修改。组织将依靠其危机管理结构、方法、策划、培训和演练。They demand a flexible, creative, strategic and sustained leadership response. Values and behaviour can be challenged and amended. The organization will rely on its crisis management structure, methods, planning, training and exercising.
危机对组织能力的挑战超出了其内在的处理能力。Crises challenge the capabilities of the organization beyond its inherent coping capacity.

问题可能升级为事件，然后是危机。组织宜认识到情况的变化并保持灵活性，以便能够相应地调整其响应措施。

![](images/mpJutSNntAae51WNGJvyXw_03.jpg)
...
![](images/mpJutSNntAae51WNGJvyXw_04.jpg)
...
![](images/mpJutSNntAae51WNGJvyXw_05.jpg)
...
![](images/mpJutSNntAae51WNGJvyXw_06.jpg)
...
![](images/mpJutSNntAae51WNGJvyXw_07.jpg)

---
*原文发表于公众号"业务连续性+" | [原文链接](https://mp.weixin.qq.com/s/mpJutSNntAae51WNGJvyXw)*
